...
A simple movies app that displays a list of movies

## Technologies

-  Core: `next`, `react`, `react-dom`, `Typescript`, `redux`, `axios`
-  UI: `tailwind`, `tailwind/forms`, `react-spring/web`
...
-  **`test`** Starts cypress test IDE (Note: Before this step, please run project using `npm run dev`).
...
```bash
git clone https://github.com/itsmohammadbahrami/movieo.git
```
